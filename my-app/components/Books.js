...
export default function Recommended({url}){
      ...
      return(
        <div >
                <div style={{width:"80%",position:"relative",left:"18vw",display:"flex",justifyContent:"start"}}>            
                    <div style={{width:"700px",height:"25px",display:"flex",justifyContent:"end",color:"navy",fontSize:"20px",fontWeight:"bolder"}} >Recommended For You</div>
