    ...
    return (
        <>
            ...
            <div className="searchModal" >
                <div className="border" style={{zIndex:"200",backgroundColor:"white",width:"350px",marginRight:'140px'}} >
                {books.map(book =>{
                        return <div key={book.id} style={{display:"flex"}} onClick={()=>{router.push(`/book/${book.id}`)}}>
