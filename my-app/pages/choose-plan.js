      ...
      return(
        <div>
            ...
            <div className="center" style={{flexDirection:"column"}} >
                ...
                <div className="center" style={{justifyContent:'center',border:"4px solid gray",width:"650px",height:"140px",margin:"20px"}}>
                    <button className="center" style={{width:"20px",height:"20px",borderRadius:"50%",border:"2px solid black",margin:"20px"}}>
